...
@CommandHandler(TakeTaskToWorkCommand)
export class TakeTaskToWorkCommandHandler extends CommandHandlerBase<
  TaskUnitOfWork,
  TaskEntity
> {
  ...
  async handle(
    ...
    task.takeToWork(new UuidVO(staffId));
